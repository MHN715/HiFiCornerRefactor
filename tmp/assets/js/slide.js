...
document.addEventListener("DOMContentLoaded", function () {
  var change;
  var index = 0;
  var gallery = ["speaker_1", "speaker_2", "speaker_3", "speaker_4", "speaker_5"];
  var text = ["Pro_ject_Debut_3_bl", "Pro_ject_Debut_III_red_1", "Pro_ject_Debut_III_yellow_1", "Pro_Ject_rpm_5", "Pro_Ject_rpm10"];
  ...
  function newPhoto() {
    ...
    document.querySelector(".slide__image").setAttribute("src", change); //TEXT
